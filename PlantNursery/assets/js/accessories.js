const products = [
    { id: 1, name: "Garden Gloves", originalPrice: 399, price: 349, img: "./assets/images/tool1.jpg", description: "Provide Protection Under Cuts, Scrapes, And Punctures From Sharp Objects Such As Thorns, Branches, And Gardening Tools." },
    { id: 2, name: "Garden Tools Kit", originalPrice: 799, price: 649, img: "./assets/images/tool2.jpg", description: "Provide Protection Under Cuts, Scrapes, And Punctures From Sharp Objects Such As Thorns, Branches, And Gardening Tools." },
    { id: 3, name: "Garden Cutters", originalPrice: 399, price: 349, img: "./assets/images/tool3.jpg", description: "Provide Protection Under Cuts, Scrapes, And Punctures From Sharp Objects Such As Thorns, Branches, And Gardening Tools." },
    { id: 4, name: "Garden Watering Can", originalPrice: 399, price: 249, img: "./assets/images/tool4.jpg", description: "Provide Protection Under Cuts, Scrapes, And Punctures From Sharp Objects Such As Thorns, Branches, And Gardening Tools." },
    { id: 5, name: "Garden Hand Rakes", originalPrice: 299, price: 249, img: "./assets/images/tool5.jpg", description: "Provide Protection Under Cuts, Scrapes, And Punctures From Sharp Objects Such As Thorns, Branches, And Gardening Tools." },
    { id: 6, name: "Garden Spade", originalPrice: 399, price: 349, img: "./assets/images/tool6.jpg", description: "Provide Protection Under Cuts, Scrapes, And Punctures From Sharp Objects Such As Thorns, Branches, And Gardening Tools." },
    { id: 7, name: "Multiocolor Pebbles", originalPrice: 399, price: 249, img: "./assets/images/tool4.jpg", description: "Provide Protection Under Cuts, Scrapes, And Punctures From Sharp Objects Such As Thorns, Branches, And Gardening Tools." },
    { id: 8, name: "Garden Hoses", originalPrice: 299, price: 249, img: "./assets/images/tool5.jpg", description: "Provide Protection Under Cuts, Scrapes, And Punctures From Sharp Objects Such As Thorns, Branches, And Gardening Tools." },
    { id: 9, name: "Ecofriendly Garden Miniature", originalPrice: 399, price: 349, img: "./assets/images/tool6.jpg", description: "Provide Protection Under Cuts, Scrapes, And Punctures From Sharp Objects Such As Thorns, Branches, And Gardening Tools." },
