document.querySelectorAll(".feedback-form").forEach(form => {
    form.addEventListener("submit", function(event) {
        ...
        // Customization Validation (Optional, max 200 chars)
        if (customization.length > 200) {
            this.querySelector(".customizationError").textContent = "Customization text should not exceed 200 characters.";
            isValid = false;
        }
